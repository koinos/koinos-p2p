...
const (
	...
	transactionApplicationTimeoutErrorScoreDefault = 250
...
type PeerErrorHandlerOptions struct {
	...
	TransactionApplicationTimeoutErrorScore uint64
...
func NewPeerErrorHandlerOptions() *PeerErrorHandlerOptions {
	return &PeerErrorHandlerOptions{
		...
		TransactionApplicationTimeoutErrorScore: transactionApplicationTimeoutErrorScoreDefault,
