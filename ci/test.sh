...
go test -v github.com/koinos/koinos-p2p/internal/inventory -coverprofile=./build/inventory.out -coverpkg=./internal/...

gcov2lcov -infile=./build/internal.out -outfile=./build/internal.info
gcov2lcov -infile=./build/node.out -outfile=./build/node.info
gcov2lcov -infile=./build/inventory.out -outfile=./build/inventory.info

lcov -a ./build/internal.info -a ./build/node.info -o ./build/merged.info
lcov -a ./build/merged.info -a ./build/inventory.info -o ./build/merged.info
